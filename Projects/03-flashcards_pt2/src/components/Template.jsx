...
const Template = () => {
    ...
    const data = [ 
        ...
        { id : 0, question : question, answer : "Spotify", img : spotify_logo1, difficulty : "easy"}, 
        { id : 1, question : question, answer : "Facebook", img : facebook_logo2, difficulty : "easy"}, 
        { id : 2, question : question, answer : "Pepsi", img : pepsi_logo3, difficulty : "easy" }, 
        { id : 3, question : question, answer : "Twitter", img : twitter_logo4, difficulty : "easy" }, 
        { id : 4, question : question, answer : "Adidas", img : adidas_logo5, difficulty : "easy"},
        { id : 5, question : question, answer : "Maserati", img : maserati_logo6, difficulty : "hard" },
        { id : 6, question : question, answer : "Audi", img : audi_logo7, difficulty : "medium" },
        { id : 7, question : question, answer : "Nestle", img : nestle_logo8, difficulty : "medium" },
        { id : 8, question : question, answer : "Cadillac", img : cadillac_logo9, difficulty : "medium" },
        { id : 9, question : question, answer : "Lamborghini", img : lamborghini_logo10, difficulty : "easy" },
        { id : 10, question : question, answer : "Honda", img : honda_logo11, difficulty : "easy" },
        { id : 11, question : question, answer : "Pizza Hut", img : pizza_hut_logo12, difficulty : "easy" },
        { id : 12, question : question, answer : "Ikea", img : ikea_logo13, difficulty : "medium" },
        { id : 13, question : question, answer : "Thai Airline", img : thai_airline_logo14, difficulty : "hard" },
        { id : 14, question : question, answer : "Ubuntu", img : ubuntu_logo15, difficulty : "hard" }, 
        { id : 15, question : question, answer : "Altria", img : altria_logo16, difficulty : "hard" }, 
        { id : 16, question : question, answer : "Cisco", img : cisco_logo17, difficulty : "hard" } ]
